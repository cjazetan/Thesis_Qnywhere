        ...
        child: StreamBuilder<List<Users>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                ...
                firtstName.text = users.first.accountFirstName;
                lastName.text = users.first.accountLastName;
                phoneNumber.text = users.first.accountPhoneNumber;
                email.text = users.first.accountEmail;
                imageUrl = users.first.imageUrl;
